		...
		for ( let i = 0; i < data.metadata.materialCount; i ++ ) {
			...
			if ( data.metadata.format === 'pmd' ) {
				...
				if ( material.textureIndex !== - 1 ) {
					...
					this.cs2 = data; if(CUSTOM_) {CS_changeTextureToAnotherUrl(CUSTOM_, data, material.textureIndex)};
				...
				if ( material.envTextureIndex !== - 1 && ( material.envFlag === 1 || material.envFlag == 2 ) ) {
					if(CUSTOM_) {CS_changeTextureToAnotherUrl(CUSTOM_, data, material.textureIndex)};
					params.matcap = this._loadTexture(
...
//Custom
function CS_changeTextureToAnotherUrl(obj, data, i){
